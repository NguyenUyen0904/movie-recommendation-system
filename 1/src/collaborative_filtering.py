...
if __name__ == '__main__':
    ...
    parser.add_argument('-k', '--num_neighbors', type=int, default=40,
    ...
    if args.save_name is None:
        args.save_name = 'cf_{}.pkl'.format(args.num_neighbors)
    with open(os.path.join(args.save_dir, args.save_name), 'wb') as f:
